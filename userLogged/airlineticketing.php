...
if (isset($_POST['btn_submit'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO airline_booking (origin, destination, checkInDate, checkOutDate, adults, children, contact, name) VALUES ('$origin', '$destination', '$checkInDate', '$checkOutDate', '$adults', '$children', '$contact', '$name')");
}
    mysqli_close($conn);
?>
