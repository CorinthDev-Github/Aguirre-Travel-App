...
if (isset($_POST['btn_submit'])) {
    ...
    $query = mysqli_query($conn, "INSERT INTO internationalhotel_booking (hotel, checkInDate, checkOutDate, adults, children, contact, name) VALUES ('$hotel', '$checkInDate', '$checkOutDate', '$adults', '$children', '$contact', '$name')");
}
    mysqli_close($conn);
?>
            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        <h2 class="room-title">Hotel Accomodation International</h2>
                    ...
                    <div class="hotel-reservation--area mb-100">
                        <form action="" method="POST">
                            <div class="form-group mb-30">
                                <label for="">International Hotel</label>
