                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Bus Reservation Table</strong>
                        </div>
                        <div class="card-body">
                            ...
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($conn, "SELECT * FROM bus_booking");
                                    $i = 1;
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Bus Reservation</h5>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>
                                                            <b>RESERVED BY:</b> <b style="text-decoration: underline;"><?php echo $row['name']; ?></b> at <b style="text-decoration: underline;"><?php echo $row['dateBooked']; ?></b>
                                                        </label>
                                                    </div>
                                                </div>
                                            </div>
                                          ...
                                          <div class="modal-footer">
                                            <a href="generatedreply_bus.php?id=<?php echo $row['id']; ?>" type="button" class="btn btn-primary">Reply</a>
