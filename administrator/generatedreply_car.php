            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST" action="monitor_car.php">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    if (isset($_GET['id'])) {
                                        $id = $_GET['id'];
                                        $query = mysqli_query($conn, "SELECT * FROM car_booking WHERE id = '$id' ");
                                        $i = 1;
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="6" style="text-align: justify;" name="automess" readonly>Your Booked has been placed in <?php echo $row['location']; ?>, where in the service type is <?php echo $row['service_type']; ?>, and the vehicle type is <?php echo $row['vehicle_type']; ?>, on <?php echo $row['date']; ?> via Banking Payments. Please contact this number +639650843610 to communicate.</textarea>
                                            </div>
                                        </div>
                                    <?php }} ?>
                                    <div class="col-md-12">
